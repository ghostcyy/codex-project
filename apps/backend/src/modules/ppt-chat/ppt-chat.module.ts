...
import { HtmlPptV2AgentService, HtmlPptV2PublishService } from "./html-ppt-v2/orchestration";
...
@Module({
  ...
  providers: [PptChatService, HtmlPptV2AgentService, DeckRendererService, HtmlPptV2PublishService, SkillRegistryService],
