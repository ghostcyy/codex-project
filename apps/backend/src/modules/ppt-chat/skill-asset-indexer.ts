 ...
 *
 * Cache lives in os.tmpdir() keyed by a content hash of the asset directories,
 * so it invalidates whenever files are added or removed.
 */
...
function cacheDir(): string {
  return join(tmpdir(), "codex-skill-manifest");
}
